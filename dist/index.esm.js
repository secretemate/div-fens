...
var Icon$B = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        React.createElement("g", { clipPath: "url(#clip0)" },
            ...
            React.createElement("path", { d: "M35.9629 36.0654L46.0085 38.7571L37.0016 72.3714L26.956 69.6797L35.9629 36.0654Z", fill: "#45d985" }),
            React.createElement("path", { d: "M11.8535 53.0029L14.5452 42.9573L61.111 55.4346L58.4193 65.4802L11.8535 53.0029Z", fill: "#45d985" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M30.0918 57.9047L40.1732 60.606L39.7591 62.1515L29.6777 59.4502L30.0918 57.9047ZM42.8724 50.5325L32.791 47.8312L33.2051 46.2857L43.2865 48.987L42.8724 50.5325Z", fill: "#45d985" })),
            ...
            React.createElement("path", { d: "M31.4707 20.8506L41.5163 18.1589L45.1398 31.6818L35.0942 34.3735L31.4707 20.8506Z", fill: "#45d985" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M31.9671 22.5998L41.9672 19.7998L41.5673 17.9998L31.3975 20.8215L31.9671 22.5998Z", fill: "#45d985" }))),
        React.createElement("defs", null,
...
var shadows = {
    ...
    focus: "0px 0px 0px 1px #45d985, 0px 0px 0px 4px rgba(118, 69, 217, 0.6)",
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        ...
        React.createElement(MenuWrapper, null,         
            React.createElement(StyledLinkTag, { href: "https://docs.defimoneyrain.com", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
                    React.createElement("img", { className: "menu-pic", alt: "docs", src: "/images/egg/gtb.png" }),
                    " ",
                    React.createElement("span", { className: "menu-text" }, "GITBOOK"))),
            React.createElement(StyledLinkTag, { href: "https://poocoin.app/tokens/0xdb6dc3B3f6EbEF3d4f5B8E1d70823f3E7151344d", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
                    React.createElement("img", { className: "menu-pic", alt: "charts", src: "/images/egg/chart.png" }),
                    React.createElement("span", { className: "menu-text" }, "POOCOIN CHART"))),
            React.createElement(StyledLinkTag, { href: "https://pancakeswap.finance/swap?inputCurrency=0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56&outputCurrency=0xdb6dc3B3f6EbEF3d4f5B8E1d70823f3E7151344d", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
                    React.createElement("img", { className: "menu-pic", alt: "exchange", src: "/images/egg/tjoe.png" }),
                    React.createElement("span", { className: "menu-text" }, "DEX"))))));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#fff", textDisabled: "#BDC2C4", textSubtle: "#c9c6ce", borderColor: "#E9EAEB", card: "rgba(9,29,44,0.87)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#fff", textDisabled: "#BDC2C4", textSubtle: "#c9c6ce", borderColor: "#E9EAEB", card: "rgba(9,29,44,0.87)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
